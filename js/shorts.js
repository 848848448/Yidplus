...
var MOCK_SHORTS = [
  { id: 'ms1', nick: 'MosheMusic', caption: '🎹 Niggun for Shabbos! #YiddishMusic #Shabbos', likes: 1240, liked: false, verified: true, media_url: '' },
  { id: 'ms2', nick: 'YidDancer', caption: '🕺 Simcha dance moves! #Simcha #JewishDance', likes: 870, liked: false, verified: false, media_url: '' },
  { id: 'ms3', nick: 'ShlomoBeats', caption: '🎤 New beat drop — Am Yisrael Chai! #Jewish #Music', likes: 2200, liked: false, verified: true, media_url: '' },
  { id: 'ms4', nick: 'KosherChef', caption: '🥘 Cholent recipe for Shabbos! #KosherFood #Cooking', likes: 510, liked: false, verified: false, media_url: '' },
  { id: 'ms5', nick: 'RebbeVibes', caption: '📖 Torah thought of the day 🙏 #Torah #Learning', likes: 320, liked: false, verified: true, media_url: '' },
  { id: 'ms6', nick: 'FiddlerNY', caption: '🎻 Klezmer jam session! #Klezmer #JewishMusic', likes: 980, liked: false, verified: false, media_url: '' }
];
...
function loadShortsFeed() {
  ...
  api.get('/shorts')
    .then(function (res) {
      ...
      if (!SHORTS_data.length) { SHORTS_data = MOCK_SHORTS; }
      renderShorts();
    })
    .catch(function () {
      // API unavailable — use mock data for demo
      SHORTS_data = MOCK_SHORTS;
      renderShorts();
    });
}
